...
/**
 * This class helps unit testing the {@link Object#equals(Object)} and
 * {@link Object#hashCode()} methods.
 *
 * <p>
 * The provided methods help ensuring that the requirements for an
 * <code>equals()</code> implementation (<em>reflexive</em>, <em>symmetric</em>,
 * <em>transitive</em>, <em>consistent</em>) and the contract between
...
public class EqualsTester<T> {
	...
	/**
	 * Creates an instance of of EqualsTester and executes <em>general</em>
	 * tests on the given <code>defaultObject</code>.
	 *
	 * <p>
	 * The general tests that are done and which should apply to all
	 * implementations of {@link Object#equals(Object) equals()} and
	 * {@link Object#hashCode() hashCode()} are:
	 * </p>
	 * <ul>
	 ...
	 * <li>Ensure that the object is not equal with
	 * <code>new Object()</code>.</li>
	 * </ul>
	 * 
	 * @param defaultObject
	 *            the object to execute the standard tests on. Must not be
	 *            <code>null</code>.
	 */
	 ...
	 *
	 * <p>
	 * Once this method was called, <code>assertNotEqual()</code> does verify
	 * the hash code any more.
	 * </p>
	 */
	 ...
	 * contract that equal objects must have equal hash codes. This method helps
	 * in ensuring this contract.
	 * </p>
	 */
	 ...
	 * <code>otherObject</code> and vice versa (is <em>symmetric</em>). Equality
	 * is determined by calling {@link Object#equals(Object) equals()} on the
	 * objects respectively. To also ensure <em>consistency</em>, the equals
	 * test is executed twice.
	 * </p>
	 * <p>
	 * If this holds true, the {@link Object#hashCode() hash code} of both
	 * objects is checked in that
	 * </p>
	 * <ul>
	 * <li>both objects must return the same hash code.</li>
	 * <li>it is <em>consistent</em>: return the same value when invoked more
	 * than once</li>
	 * </ul>
	 * <p>
	 * An {@link java.lang.AssertionError AssertionError} is thrown if any of
	 * the two mentioned conditions is not true.
	 * </p>
	 *
	 * @param object
	 *            an object that should be equal to <code>otherObject</code>.
	 *            Must not be <code>null</code>
	 * @param otherObject
	 *            the object with which <code>object</code> is compared
	 * @throws AssertionError
	 *             if <code>object</code> and <code>otherObject</code> is either
	 *             not equal or if their hash code differs.
	 */
	...
	/**
	 * Ensures that the <code>equals()</code> implementation of the given
	 * objects is <em>transitive</em>.
	 *
	 * <p>
	 ...
	 * <p>
	 * An {@link java.lang.AssertionError AssertionError} is thrown if any of
	 * the equals tests fail.
	 * </p>
	 *
	 * @param object1
	 *            an object that should be equal to <code>object2</code> and
	 *            <code>object3</code>. Must not be <code>null</code>.
	 * @param object2
	 *            an object that should be equal to <code>object1</code> and
	 *            <code>object3</code>. Must not be <code>null</code>.
	 * @param object3
	 *            an object that should be equal to <code>object1</code> and
	...
	/**
	 * Ensures that the given objects are not equal. If not suppressed it is
	 * also ensured that the hash code of the objects differs.
	 *
	 * <p>
	 * The method tests if the given <code>object</code> is not equal to
	 * <code>otherObject</code> by using its {@link Object#equals(Object)
	 * equals()} method. Though not strictly required by the equals and
	 * {@link Object#hashCode() hash code} contract, it helps hash tables when
	 * the hash code of unequal objects also differs. Therefore it is also
	 * ensured that the hash code of both objects isn't equal. This test can be
	 * suppressed by calling {@link #omitHashCodeTestForUnequalPairs()}
	 * beforehand.
	 * </p>
	 * <p>
	 * An {@link java.lang.AssertionError AssertionError} is thrown if any of
	 * the above mentioned conditions is not true.
	 * </p>
	 *
	 * @param object
	 *            an object that should not be equal to
	 *            <code>otherObject</code>. Must not be <code>null</code>
	 * @param otherObject
	 *            the object with which <code>object</code> is compared
	 * @throws AssertionError
	 *             if <code>object</code> and <code>otherObject</code> is either
	 *             equal or if their hash codes are the same.
	 */
